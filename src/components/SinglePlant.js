...
const SinglePlant = () => {
  ...
  }; // Create a Cloudinary instance and set your cloud name. //   const cld = new Cloudinary({ //     cloud: { //       cloudName: 'garden-planner', //     }, //     //url: 'https://res.cloudinary.com/garden-planner/image/upload/v1654781197/test/IMG_9052_zzibtf.jpg' // } );
  ...
  }); // cld.image returns a CloudinaryImage with the configuration set. //const myImage = cld.image('test/IMG_9052_zzibtf');
